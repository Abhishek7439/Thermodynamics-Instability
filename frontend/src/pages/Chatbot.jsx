      ...
      <div className="p-4 border-t border-blue-900/30">
        <form onSubmit={handleSubmit} className="flex gap-2">
          <input
            ...
            className="flex-1 px-4 py-2.5 rounded-xl glass border border-blue-700/30 text-white text-sm placeholder-blue-500 outline-none focus:border-blue-500/60 transition-colors"
            style={{ background: 'rgba(15,40,71,0.6)' }}
          />
          <motion.button
            type="submit"
